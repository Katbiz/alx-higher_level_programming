...
class Base:
    ...
    def create(cls, **dictionary):
        ...
        Create a Rectangle or Square instance  mandatory,
        attributes (width, height, size, etc.),
        Call update instance method to  instance to apply your,
        real values.
    ...
    def draw(list_rectangles, list_squares):
        ...
        window.exitonclick()doesndummythis dummywith dummya 
