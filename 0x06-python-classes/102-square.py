...
class Square:
    ...
    def __lt__(self, other):
        """
        A rich comparison operator to compare if square area is less
        than another.
    ...
    def __ne__(self, other):
        ...
        Arich comparison operator to compare if square area is not
        equal to another.
    ...
    def __gt__(self, other):
        """
        A rich comparison operator to compare if square area is greater
        than another.
    ...
    def __ge__(self, other):
        """ Its rich comparison operator to compare if square area is greater
        than or equal to another.
