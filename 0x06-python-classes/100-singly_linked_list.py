...
class Node:
    """
    A class that defines properties Node.

    Attributes:
        data: data field of node.
    """
    def __init__(self, data, next_node=None):
        """It creates new instances of node.
    ...
    @property
    def data(self):
        """It retrieves the data field instance.
    ...
    @property
    def next_node(self):
        """It retrives the next_node instance.
...
class SinglyLinkedList:
    """
    Is a class that defines properties of SinglyLinkedList.

    Attributes:
        head: head of the SinglyLinkedList.
    """
    def __init__(self):
        """It creates new instances of SinglyLinkedList .
    ...
    def __str__(self):
        """it represents the class objects as a string.

        Returns:class object represented as a string.
        """
    ...
    def sorted_insert(self, value):
        """It insert a new node at a given position.
